...
'var dataslayer = {}; dataslayer.helperListener = function (message,model){var poster = {type: \'dataslayergtm\',gtmID: document.querySelector(\'script[src*=googletagmanager\\\\.com]\').getAttribute(\'src\').match(/GTM.*/), data: JSON.stringify(window.dataLayer)}; window.postMessage(poster,"*");};'+
...
dataslayers.innerHTML = insertScript;
